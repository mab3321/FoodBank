    ...
    @if (!blank($carts))
        ...
        <div class="cart-scroll-group">
            ...
            <h3
                ...
                {{ __('frontend.your_cart') }}
            </h3>

            @foreach ($groupedItems as $restaurantId => $group)
                <div class="restaurant-group mb-3" style="border-bottom: 1px solid var(--border-slate); padding-bottom: 12px;">
                    <h4 class="restaurant-group-name" style="font-size: 14px; font-weight: 600; color: var(--primary); margin-bottom: 12px;">
