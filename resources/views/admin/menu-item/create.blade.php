						...
						<div class="row">
                            ...
                            <div class="col-12 sm:col-6 md:col-4 xl:col-3">
								...
								<div class="db-field-down-arrow">
									<select name="restaurant_id" class="db-field-control appearance-none @error('restaurant_id') invalid @enderror">
										<option value="">---</option>
                            ...
                            <div class="col-12 sm:col-6 md:col-4 xl:col-3">
								...
								<input type="number" name="wait_time" id="wait_time" min="1" max="120" class="db-field-control @error('wait_time') invalid @enderror" value="{{ old('wait_time', 15) }}" placeholder="e.g., 20">
